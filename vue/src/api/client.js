...
export function getTypes(){
	const res = axios.get('/api/mall/good/getType');
...
export function getGoodsList(typeId){
	const res = axios.get('/api/mall/good/getGoodsByType?typeId='+typeId);
...
export function getGoodsInfo(id){
	const res = axios.get('/api/mall/good/getGoodInfo?id='+id);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
...
export function getGoodsMsg(id){
	const res = axios.get('/api/mall/reply/getGoodMsg?id='+id);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
...
export function askGoodsMsg(data){
	const res = axios.post('/api/mall/reply/askGoodMsg',data);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
...
export function getUserData(token){
	const res = axios.get('/api/mall/user/getUserInfo?token='+token);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
...
export function sendComment(data){
	const res = axios.post('/api/mall/comment/sendComment',data);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
...
export function getComment(goodsId){
	const res = axios.get('/api/mall/comment/getGoodComment?goodsId='+goodsId);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
...
export function searchGoods(keyword=''){
	const res = axios.get('/api/mall/good/searchGoods?keyword='+keyword);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
